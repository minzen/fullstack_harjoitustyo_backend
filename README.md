...
Backendin (eli GraphQL-API, joka laukkaa ApolloServerin päällä) tämänhetkinen versio löytyy osoitteesta: https://sleepy-woodland-08922.herokuapp.com/graphql
